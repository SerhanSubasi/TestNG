...
public class Listeners implements ITestListener, IRetryAnalyzer, IAnnotationTransformer {
    ...
    /*
    Bu method sadece Fail olan test methodlarımızı tekrar çalıştırır.
    Şu an ki haliyle maxRetryCount = 1; kaç yazarsanız o kadar tekrar çalıştırılır.
     */
    ...
    /*
    Bu method sadece Fail olan test methodlarımızı tekrar çalıştırır.
    teknik olarak test notasyonlarını, classları, constructorları ve methodları transform etmemize olanak sağlar.
